...
species.in.intermed <- read_csv("data/raw/intermediate-dependency1.1_species-list_location-independent.csv")
species.de.intermed <- read_csv("data/raw/intermediate-dependency1.1_species-list_location-dependent.csv")
...
write_csv(seeded.marked.notnative,
          file = "data/raw/intermediate-dependency1.1_seeded-species-to-be-marked-native.csv")
