...
prism.dat <- read.csv("data/cleaned/03.2_monitoring-events-with-PRISM-climate-data_clean.csv")
...
ai_raster <- raster(x = "C:/Users/liaos/OneDrive - University of Arizona/grad school/Gornish lab/04_RAMPS RestoreNet/RestoreNet/data/Global-AI_ET0_annual_v3/ai_v3_yr.tif")
