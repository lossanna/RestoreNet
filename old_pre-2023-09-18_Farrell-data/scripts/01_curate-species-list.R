...
plot.2x2.raw <- read_xlsx("old_pre-2023-09-18_Farrell-data/data/raw/Master Germination Data 2022.xlsx", sheet = "AllPlotData")
species.raw <- read_xlsx("old_pre-2023-09-18_Farrell-data/data/raw/from-Master_species-list-with-native-status_LO.xlsx")
...
native.fix <- read_csv("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01-dependency_seeded-species-to-be-marked-native.csv")
...
write_csv(subplot.missing,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species1_subplot-codes-missing.csv")
head(subplot.missing)

# EDITED: manually edit new file to add Name, Native, Lifeform, and Duration cols
sub.missing <- read_csv("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01b_edited-species1_subplot-codes-missing_native-duration-lifeform.csv")
head(sub.missing)
...
write_csv(subplot.in.lifeform.inspect,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species2_subplot-lifeform-info.csv")

# EDITED: delete incorrect rows so there is only one lifeform assignment per code
subplot.in.duplicate <- read_csv("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01b_edited-species2_subplot-lifeform-info-corrected.csv")
...
write_csv(lifeform.na,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species3_xlsx_lifeform-na.csv")
head(lifeform.na)

# EDITED: manually edit new file and fill in Lifeform col
lifeform.na.edit <- read_csv("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01b_edited-species3_xlsx_lifeform-na.csv")
...
write_csv(species.m.known,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species4_xlsx_native-lifeform.csv")
...
species.m.known <- read_csv("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01b_edited-species4_xlsx_native-lifeform-duration.csv")
head(species.m.known)
...
write_csv(species.in,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01-dependency_species-list_location-independent.csv")
head(species.in)
...
write_csv(species.de,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species5.1_location-dependent.csv")
...
write_csv(sites.m.unk,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species5.2_location-dependent_xlsx_sites.csv")
...
species.de <- read_csv("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01b_edited-species5_location-dependent_native-duration-lifeform.csv")
head(species.de)
...
write_csv(species.de,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01-dependency_species-list_location-dependent.csv")
...
write_csv(p2x2.codes.missing,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species6_codes-missing-2x2plot.csv")
...
p2x2.codes.missing <- read_csv("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01b_edited-species6_codes-missing-2x2plot.csv")
head(p2x2.codes.missing)
...
write_csv(species.in,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species7_location-independent-final-check.csv")
...
species.in <- read_xlsx("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01b_edited-species7_location-independent-final-fix.xlsx")

# Write to csv
write_csv(species.in,
          file = "old_pre-2023-09-18_Farrell-data/data/cleaned/species-list_location-independent_clean.csv")
...
write_csv(species.de,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species8_location-dependent-final-check.csv")

# EDITED: remove rows that are (functionally) duplicates
#   See Excel file textbox for changes
species.de <- read_xlsx("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01b_edited-species8_location-dependent-final-fix.xlsx")
...
# Write to csv
write_csv(species.de,
          file = "old_pre-2023-09-18_Farrell-data/data/cleaned/species-list_location-dependent_clean.csv")
...
write_csv(subplot.codes.in,
          file = "old_pre-2023-09-18_Farrell-data/data/cleaned/subplot_species-list_location-independent_clean.csv")
...
write_csv(subplot.codes.de,
          file = "old_pre-2023-09-18_Farrell-data/data/cleaned/01_subplot_species-list_location-dependent_clean.csv")
...
write_csv(p2x2.codes.in.dup,
          file = "old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01a_output-species9_p2x2-location-independent-need-duplicate-number.csv")
...
p2x2.codes.in.dup <- read_csv("old_pre-2023-09-18_Farrell-data/data/data-wrangling-intermediate/01b_edited-species9_p2x2-location-independent-duplicate-number-added.csv")
...
write_csv(p2x2.codes.in,
          file = "old_pre-2023-09-18_Farrell-data/data/cleaned/p2x2_species-list_location-independent_clean.csv")
...
write_csv(p2x2.codes.de,
          file = "old_pre-2023-09-18_Farrell-data/data/cleaned/p2x2_species-list_location-dependent_clean.csv")



save.image("old_pre-2023-09-18_Farrell-data/RData/01_curate-species-list.RData")
