...
# Purpose: First iteration of results for fall-warm model selection.
...
# All variables
warm.fall_full <- glmmTMB(Count ~ Perc_dev_since + AridityIndex +
...
save.image("RData/warm-fall01.RData")
sessionInfo()