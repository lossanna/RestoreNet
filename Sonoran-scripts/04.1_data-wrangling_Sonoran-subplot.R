...
monitor.fixed <- read_csv("Sonoran-data/data-wrangling-intermediate/02_subplot-wrong-monitor-events-corrected.csv")
...
# Change "Yes?" to "No", as it is an unknown
species.seeded.not.in.mix$SpeciesSeeded[species.seeded.not.in.mix$Code == "BOUSPP.SRER"] <- "No"
subplot$SpeciesSeeded[subplot$Code == "BOUSPP.SRER"] <- "No"

# Change BOER4 to "No", as BOER4 was not seeded at SRER
species.seeded.not.in.mix$SpeciesSeeded[species.seeded.not.in.mix$Code == "BOER4"] <- "No"
subplot$SpeciesSeeded[subplot$Code == "BOER4"] <- "No"
...
write_csv(species.seeded.in.mix,
          file = "Sonoran-data/data-wrangling-intermediate/04.1a_output1_seeded-in-mix_subplot.csv")
...
# Change "?" to "No", as this is an unknown grass
species.unk.seeded$SpeciesSeeded[species.unk.seeded$Code == "UNGR_S_2.SRER"] <- "No"
subplot$SpeciesSeeded[subplot$Code == "UNGR_S_2.SRER"] <- "No"
...
write_csv(species.na.seeded,
          file = "Sonoran-data/data-wrangling-intermediate/04.1a_output2_NA-seeded_subplot.csv")
...
species.na.seeded <- read_xlsx("Sonoran-data/data-wrangling-intermediate/04.1b_edited2_corrected-NA-seeded_subplot.xlsx")
...
write_csv(species.no.seeded,
          file = "Sonoran-data/data-wrangling-intermediate/04.1a_output3_not-seeded_subplot.csv")
...
seeded.correct[duplicated(seeded.correct[, 1:9]), ] # none
...
subplot <- subplot |>
  mutate(PlotMix_Climate = case_when(
    ...
    str_detect(subplot$Site, "Preserve|SCC|Roosevelt|Pleasant") &
...
write_csv(subplot,
          file = "Sonoran-data/cleaned/04.1_subplot-data_clean.csv")


save.image("Sonoran-RData/04.1_data-wrangling_subplot.RData")
